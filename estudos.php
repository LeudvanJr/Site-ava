...
<?php
    ...
    <ul>
        ...
        <li><a  href="atividades.php"><svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                ...
                Atividades</a></li>
        <li><a href="estudos.php" class="active"><svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <li><a href="cronograma.php"><svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
